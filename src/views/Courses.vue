              ...
              <!-- <form class="w-3/12 block bg-white p-4 px-6 shadow rounded-sm" method="GET"> -->
                  ...
                  <div class="pt-6">
                    <div class="space-y-2">
                      <div class="relative mt-1 rounded-md shadow-sm">
                        ...
                        <!-- <form action="" @submit.prevent="searchQuery()"> -->
                          <input type="text" v-model="search" @input="searchQuery" class="block w-full rounded border border-gray-300 bg-white py-2 pl-10 pr-3 leading-5 placeholder-gray-500 focus:border-indigo-500 focus:placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-indigo-500 sm:text-sm" placeholder="Enter keywords">
                ...
                <div class="border-b border-gray-200 py-6">
                  ...
                  <div class="pt-6">
                    <div class="space-y-2">
                      ...
                      <div class="flex items-center">
                        <input @change="getAllCourse" v-model="price" id="filter-price-onetime" value="paid" type="checkbox" class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                        <label for="filter-price-onetime" class="ml-3 text-sm text-gray-600"> Paid <span class="text-xs text-gray-500">(9)</span>
                        </label>
                      </div>
                    </div>
                  </div>
                ...
                <div class="border-b border-gray-200 py-6">
                  ...
                  <div class="pt-6">
                    <div class="space-y-2">
                      <div class="flex items-center">
                        <input @change="getAllCourse" v-model="duration" id="filter-duration-1h-5h" value="1h-5h" type="checkbox" class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                        <label for="filter-duration-1h-5h" class="ml-3 text-sm text-gray-600"> 1-5 hours <span class="text-xs text-gray-500">(16)</span>
                        </label>
                      </div>
                      <div class="flex items-center">
                        <input @change="getAllCourse" v-model="duration" id="filter-duration-5h-10h" value="5h-10h" type="checkbox" class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                        <label for="filter-duration-5h-10h" class="ml-3 text-sm text-gray-600"> 5-10 hours <span class="text-xs text-gray-500">(6)</span>
                        </label>
                      </div>
                      <div class="flex items-center">
                        <input @change="getAllCourse" v-model="duration" id="filter-duration-10h+" value="10h+" type="checkbox" class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                  ...
                  <div class="pt-6">
                    <div class="space-y-2">
                      ...
                      <div v-for="platform in platforms" class="flex items-center">
                        <input @change="getAllCourse" v-model="selectedPlatforms" id="filter-platform-1" :value="platform.id" type="checkbox" class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                  ...
                  <div class="pt-6">
                    <div class="space-y-2">
                      <div v-for="item in series" class="flex items-center">
                        <input @change="getAllCourse" v-model="selectedSeries" id="filter-series-1" :value="item.id" type="checkbox" class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                        <label for="filter-series-1" class="ml-3 text-sm text-gray-600"> {{ item.name }} <span class="text-xs text-gray-500">(18)</span>
                        </label>
                      </div>
                    </div>
                  </div>
...
export default {
    ...
    methods: {
      ...
      getAllCourse(){
        this.loading = true
        axios.get('https://localhost/laravel-courses/public/api/all-courses',{
          params:{
            search:this.search,
            price:this.price,
