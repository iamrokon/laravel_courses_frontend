        ...
        <div class="container mx-auto">
            <ul class="flex items-center flex-nowrap justify-between gap-y-7 gap-3">
                <li class="w-full lg:max-w-[165px]">
                    <router-link to="/" class="bg-white border mx-auto border-orange box-shadow w-full h-12 md:h-16 rounded-lg flex items-center justify-center">
       ...
       <!--Feature Section-->
        <div class="container mx-auto mt-[140px]">
            ...
            <div class="w-full grid grid-cols-3 single-feature gap-10 mx-auto">
                <!--Single Item-->
                <CourseBox v-for="item in courses" :course="item"/>
                <!--Single Item end-->
            </div>
...
export default {
    ...
    mounted(){
      axios.get('https://localhost/laravel-courses/public/api/courses').then(response => {
